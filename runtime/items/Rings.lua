...
Data.equipment_create {
    name = "Wizard's Ring",
    description = "A ring that gives the user faster spell and action cooldown. It also enables the user to regain mana on every kill.",
    type = "ring",
    ...
    stat_bonuses = {
        spell_cooldown_multiplier = 0.95
    }
}
...
Data.equipment_create {
    ...
    stat_bonuses = {
        ...
        powerfulness = 1, willpower = -1, mp = 10 }
}

Data.equipment_create {
    name = "Stara's Ring",
    description = "Grants the user +35MP, +2 willpower.",
    type = "ring",
    ...
    stat_bonuses = { willpower = 2, mp = 35}
}

Data.equipment_create {
    name = "Magician's Ring",
    description = "A glowing ring that grants the user a modest increase in spell or action cooldown recovery.",
    type = "ring",
