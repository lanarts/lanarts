...
local TextInputBox = require "ui.TextInputBox"
...
local function connection_toggle_create()
    ...
    local client_option_image = image_cached_load("interface/sprites/config/client_icon.png")
...
local function respawn_toggle_create()
    ...
    local respawn = image_cached_load("interface/sprites/config/respawn_setting.png")
    local hardcore = image_cached_load("interface/sprites/config/hardcore_setting.png")
...
local function class_choice_buttons_create()
    ...
    local buttons = {
        ...
        -- { "Templar", sprite_base .. "fighter.png", COL_WHITE},
        { "Pyrocaster", sprite_base .. "redmage.png", COL_PALE_RED},
        -- { "Bard", sprite_base .. "bluemage.png", COL_PALE_BLUE},
